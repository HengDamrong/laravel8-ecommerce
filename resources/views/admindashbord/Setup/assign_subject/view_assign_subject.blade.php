                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 22%;">
                                            <a href="{{route('assign.subject.edite',$row->class_id)}}" class="btn btn-info">Update</a>
                                            <a href="{{route('assign.subject.details',$row->class_id)}}" class="btn btn-primary">Details</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
